                ...
                <td class="px-3 py-3">
                    <x-dropdown align="right" width="40">
                        ...
                        <x-slot name="content">
                            ...
                            <!-- Delete Button -->
                            <form action="{{ route('admin.rooms.destroy', $room->id) }}" method="POST" class="border-t border-gray-100 dark:border-gray-700">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
                                        onclick="return confirm('Are you sure you want to delete \"{{ $room->room_name }}\"?')"
